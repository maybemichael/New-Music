...
class PlaylistCellContentView: UIView, UIContentView {
    ...
    let containerView: UIView = {
        ...
        view.setSize(width: UIScreen.main.bounds.width, height: 96)
        return view
    }()
    ...
    private func setupViews() {
        ...
        playlistNameLabel.anchor(top: containerView.topAnchor, leading: containerView.leadingAnchor, trailing: containerView.trailingAnchor, padding: .init(top: 8, left: 20, bottom: 0, right: 0))
